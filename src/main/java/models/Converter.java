...
public class Converter {
    ...
    public static Movie fromJsonString(String json) throws IOException {
        return getObjectReader().readValue(json);
    }

    public static String toJsonString(Movie obj) throws JsonProcessingException {
    ...
    private static void instantiateMapper() {
        ...
        reader = mapper.readerWithView(Movie.class);
        writer = mapper.writerFor(Movie.class);
    }
